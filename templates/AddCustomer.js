...
apiCall("/customers/save","POST",CustomerForm, function(response)
{
console.log(CustomerForm);
console.log(response);
console.log("data is",response.data)
console.log("Id is",response.data.customerId)
const url = `/customer/details/${response.data.customerId}`;
